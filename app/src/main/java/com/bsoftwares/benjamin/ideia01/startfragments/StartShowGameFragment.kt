...
class StartShowGameFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnStartGameShow.setOnClickListener {
            selecionarPerguntas()
            startActivity(Intent(context, GameActivity::class.java).putExtra("PerguntasSelecionadas",listaPerguntasSelecionadas).putExtra("isGameShow",true).putExtra("Jogador",edNomeJogador.text.toString()))
